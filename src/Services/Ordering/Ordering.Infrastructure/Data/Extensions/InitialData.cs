namespace Ordering.Infrastructure.Data.Extensions
{
    internal class InitialData
    {
        ...
        [
            ...
            Product.Create(ProductId.Of(new Guid("c67d6323-e8b1-4dbf-9a75-b0d0d2e7e914")), "Samsung 10", 400),
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                ...
                order1.Add(ProductId.Of(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61")), 2, 500.00m);
                order1.Add(ProductId.Of(new Guid("c67d6323-e8b1-4dbf-9a75-b0d0d2e7e914")), 1, 400.00m);
                ...
                order2.Add(ProductId.Of(new Guid("4f136e9f-ff8c-4c1f-9a33-d12f689bdab8")), 1, 650.00m);
                order2.Add(ProductId.Of(new Guid("6ec1297b-ec0a-4aa1-be25-6726e3b51a27")), 2, 450.00m);
